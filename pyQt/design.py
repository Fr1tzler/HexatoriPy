...
class Ui_HexatoriPy(object):
    def setupUi(self, HexatoriPy):
        ...
        self.newGameButton.setGeometry(QtCore.QRect(640, 40, 120, 120))
        ...
        self.solveButton.setGeometry(QtCore.QRect(640, 340, 120, 120))
        ...
        self.groupBox.setGeometry(QtCore.QRect(640, 250, 108, 82))
